                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <h3 class="card-title">Add AMC</h3>
                                ...
                                <form id="ClientUpdate" autocomplete="off">
                                    <div class="row mb-3">
                                      <div class="col">
                                        ...
                                        <input type="text" id="amc_id" class="form-control" name="amc_id" value="{{$amc_id}}" required>
                                      </div>
                                      <div class="col">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                          ...
                                          <div class="col">
                                            ...
                                            <input type="date" id="amc_start_date" class="form-control" name="amc_start_date" required>
                                          </div>
                                    </div>
                                    ...
                                    <div class=" row mb-3">
                                        <div class="col">
                                            ...
                                            <input type="date" id="amc_end_date" class="form-control" name="amc_end_date" required>
                                          </div>
                                    <div class="col">
                                        ...
                                        <select class="form-control" name="currency" id='currency'  required>
                                            ...
                                            @foreach($currencies as $currency)
                                                <option value="{{$currency->id}}" {{$currency->Currency == 'INR' ? 'selected' : ''}} >{{$currency->Currency}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
